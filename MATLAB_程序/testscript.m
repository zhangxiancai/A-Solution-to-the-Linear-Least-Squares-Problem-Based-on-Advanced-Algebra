...
%     
 ...
 plot(rest(1,:),rest(2,:),"--o",rest(1,:),rest(3,:),"-*");xlim([0,4100]);
legend("NGDM","AAM",'Location','northwest',"fontsize",14,"fontname","arial",'color','none'); 
 xlabel("Record count","fontsize",14,"fontname","arial");ylabel("Time/s","fontsize",14,"fontname","arial");set(gca,'color','none');
 figure
 plot(rese(1,:),rese(2,:),"--o",rese(1,:),rese(3,:),"-*");xlim([0,4100]);
legend("NGDM","AAM","fontsize",14,"fontname","arial",'color','none'); 
 xlabel("Record count","fontsize",14,"fontname","arial");ylabel("MAPE/%","fontsize",14,"fontname","arial");set(gca,'color','none');
